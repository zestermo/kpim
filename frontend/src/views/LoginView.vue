      ...
      <div class="w-full max-w-md">
        ...
        <div class="lg:hidden text-center mb-8">
          <img 
            src="/images/logo.png" 
            alt="KPOP IDOL MANAGER 2025" 
            class="w-auto max-w-[280px] h-auto mx-auto mb-4 pixel-art"
          />
        </div>
        ...
        <div class="game-panel p-8">
          ...
          <p class="text-gray-400 text-center mb-8">Sign in to your agency</p>
          ...
          <div class="mt-8 text-center">
            ...
            <router-link 
              to="/register" 
              class="inline-block mt-2 text-kpop-pink-400 hover:text-kpop-pink-300 font-bold text-lg transition-colors"
            >
              Create Your Agency →
            </router-link>
          </div>
        ...
        <div class="mt-6 text-center">
          ...
          <p v-if="!hasInteracted" class="text-gray-600 text-xs mt-2">
